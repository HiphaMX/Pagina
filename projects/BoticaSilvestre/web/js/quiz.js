const PRODUCTS_DB = {
  ...
  step2: [
    { id: 'rana', product: 'Colita de Rana', subtitle: 'Aceite de coco + Cera de abeja + Herbolaria', icon: 'activity', desc: 'Dolor muscular con la actividad física', price: 190, image: 'assets/images/Product Shots/Colita de rana1.webp' },
    { id: 'descansa', product: 'Descansa', subtitle: 'Aceite de coco + Cera de abeja + Herbolaria', icon: 'wind', desc: 'Mis piernas terminan cansadas después de un día activo', price: 190, image: 'assets/images/Product Shots/Descansa1.webp' },
    { id: 'abacho', product: 'Abacho', subtitle: 'Aceite de coco + Cera de abeja + Herbolaria', icon: 'heart', desc: 'Necesidad de acariciarme y aceptarme más', price: 190, image: 'assets/images/Product Shots/Abacho1.webp' },
    { id: 'piel', product: 'Piel Silvestre', subtitle: 'Aceite de coco + Cera de abeja + Herbolaria', icon: 'sun', desc: 'Piel delicada que se pone sensible con la exposición al sol', price: 250, image: 'assets/images/Product Shots/PielSilvestre1.webp' },
